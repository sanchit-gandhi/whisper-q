...
class WhisperAttention(nn.Module):
    ...
    # Copied from transformers.models.whisper.modeling_whisper.BartAttention.forward with BART->whisper
    def forward(
        self,
...
class WhisperBnbForConditionalGeneration(WhisperPreTrainedModel):
    ...
    def forward(
        ...
        labels (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*):
            ...
            only computed for the tokens with labels in `[0, transformers., config.vocab_size]`.
